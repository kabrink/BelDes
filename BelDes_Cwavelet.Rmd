...
beldes = read.csv('~/Dropbox/Research/Michigan/fNIRS/BelDes/Repo/meanResults_Correct_Wavelet.txt')
```
...
```{r remove_bel_J19}
#beldes$mean_bel_J19[which(beldes$subID=="104_JD")] = NA
beldes$mean_bel_J19[which(beldes$subID=="108_RW")] = NA
beldes$mean_bel_J19[which(beldes$subID=="115_HC")] = NA
#beldes$mean_bel_J19[which(beldes$subID=="118_ZT")] = NA
beldes$mean_bel_J19[which(beldes$subID=="122_KD")] = NA
#beldes$mean_phys_J19[which(beldes$subID=="124_CK")] = NA

#beldes$area_bel_J19[which(beldes$subID=="104_JD")] = NA
beldes$area_bel_J19[which(beldes$subID=="108_RW")] = NA
beldes$area_bel_J19[which(beldes$subID=="115_HC")] = NA
#beldes$area_bel_J19[which(beldes$subID=="118_ZT")] = NA
beldes$area_bel_J19[which(beldes$subID=="122_KD")] = NA
#beldes$area_phys_J19[which(beldes$subID=="124_CK")] = NA

#beldes$max_bel_J19[which(beldes$subID=="104_JD")] = NA
beldes$max_bel_J19[which(beldes$subID=="108_RW")] = NA
beldes$max_bel_J19[which(beldes$subID=="115_HC")] = NA
#beldes$max_bel_J19[which(beldes$subID=="118_ZT")] = NA
beldes$max_bel_J19[which(beldes$subID=="122_KD")] = NA
#beldes$max_phys_J19[which(beldes$subID=="124_CK")] = NA
```

```{r remove_bel_L19}
beldes$mean_bel_L19[which(beldes$subID=="108_RW")] = NA
beldes$mean_bel_L19[which(beldes$subID=="121_MT")] = NA
beldes$mean_bel_L19[which(beldes$subID=="123_ES")] = NA

beldes$area_bel_L19[which(beldes$subID=="108_RW")] = NA
beldes$area_bel_L19[which(beldes$subID=="121_MT")] = NA
beldes$area_bel_L19[which(beldes$subID=="123_ES")] = NA

beldes$max_bel_L19[which(beldes$subID=="108_RW")] = NA
beldes$max_bel_L19[which(beldes$subID=="121_MT")] = NA
beldes$max_bel_L19[which(beldes$subID=="123_ES")] = NA
```

```{r remove_des_J19}
beldes$mean_des_J19[which(beldes$subID=="109_LM")] = NA
#beldes$mean_des_J19[which(beldes$subID=="121_MT")] = NA
beldes$mean_des_J19[which(beldes$subID=="122_KD")] = NA

beldes$area_des_J19[which(beldes$subID=="109_LM")] = NA
#beldes$area_des_J19[which(beldes$subID=="121_MT")] = NA
beldes$area_des_J19[which(beldes$subID=="122_KD")] = NA

beldes$max_des_J19[which(beldes$subID=="109_LM")] = NA
#beldes$max_des_J19[which(beldes$subID=="121_MT")] = NA
...
beldes$mean_phys_J19[which(beldes$subID=="108_RW")] = NA
beldes$mean_phys_J19[which(beldes$subID=="109_LM")] = NA
beldes$mean_phys_J19[which(beldes$subID=="113_ID")] = NA

beldes$area_phys_J19[which(beldes$subID=="107_CW")] = NA
beldes$area_phys_J19[which(beldes$subID=="108_RW")] = NA
beldes$area_phys_J19[which(beldes$subID=="109_LM")] = NA
beldes$area_phys_J19[which(beldes$subID=="113_ID")] = NA

beldes$max_phys_J19[which(beldes$subID=="107_CW")] = NA
beldes$max_phys_J19[which(beldes$subID=="108_RW")] = NA
beldes$max_phys_J19[which(beldes$subID=="109_LM")] = NA
beldes$max_phys_J19[which(beldes$subID=="113_ID")] = NA
```

```{r remove_phys_L19}
beldes$mean_des_L19[which(beldes$subID=="109_LM")] = NA
beldes$mean_des_L19[which(beldes$subID=="122_KD")] = NA

beldes$area_des_L19[which(beldes$subID=="109_LM")] = NA
beldes$area_des_L19[which(beldes$subID=="122_KD")] = NA

beldes$max_des_L19[which(beldes$subID=="109_LM")] = NA
...
##Mean analysis 
```{r mean_analysis_by_channel, eval=TRUE}
...
```{r plot_mean_differences_L19, fig.path='Figures/', dev=c('png','postscript'), eval=TRUE}
...
```{r area_analysis_by_channel, eval=TRUE}
...
```{r plot_area_differences_L19, fig.path='Figures/', dev=c('png','postscript'), eval=TRUE}
...
p = ggplot(data = diffPlotData, aes(x = Condition, y = Difference, fill = Condition)) + guides(fill=FALSE)
p = p + geom_bar(position=position_dodge(width = .4), stat="identity", width = .6) + 
    geom_errorbar(aes(ymin=Difference-ci, ymax=Difference+ci),
                  width=.15,
                  size = 2, # Width of the error bars
                  position=position_dodge(.9))
...
```{r max_analysis_wavelet_correct, eval=TRUE}
#Belief compared to desire in J19
...
#Behavioral
```{r}
t.test(beldes$BelResp.ER,
       beldes$DesResp.ER,
       paired=T)

t.test(beldes$DesResp.ER,
       beldes$PhysResp.ER,
       paired=T)
