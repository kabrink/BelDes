---
title: "Belief-Desire: fNIRS Analysis - PCA"
...
beldes = read.csv('~/Dropbox/Research/Michigan/fNIRS/BelDes/Repo/meanResults_Correct_PCA.txt')
```
...
```{r remove_bel_J19}
beldes$mean_bel_J19[which(beldes$subID=="113_ID")] = NA
beldes$mean_bel_J19[which(beldes$subID=="123_ES")] = NA

beldes$area_bel_J19[which(beldes$subID=="113_ID")] = NA
beldes$area_bel_J19[which(beldes$subID=="123_ES")] = NA

beldes$max_bel_J19[which(beldes$subID=="113_ID")] = NA
beldes$max_bel_J19[which(beldes$subID=="123_ES")] = NA
```

```{r remove_bel_L19}
beldes$mean_bel_L19[which(beldes$subID=="113_ID")] = NA

beldes$area_bel_L19[which(beldes$subID=="113_ID")] = NA

beldes$max_bel_L19[which(beldes$subID=="113_ID")] = NA
```

```{r remove_des_J19}
beldes$mean_des_J19[which(beldes$subID=="113_ID")] = NA

beldes$area_des_J19[which(beldes$subID=="113_ID")] = NA

beldes$max_des_J19[which(beldes$subID=="113_ID")] = NA

```

```{r remove_des_L19}
beldes$mean_des_L19[which(beldes$subID=="113_ID")] = NA

beldes$area_des_L19[which(beldes$subID=="113_ID")] = NA

beldes$max_des_L19[which(beldes$subID=="113_ID")] = NA
```

```{r remove_phys_J19}
beldes$mean_phys_J19[which(beldes$subID=="119_GM")] = NA

beldes$area_phys_J19[which(beldes$subID=="119_GM")] = NA

beldes$max_phys_J19[which(beldes$subID=="119_GM")] = NA
```
...
diffPlotData = data.frame(Condition = c("Belief>Baseline",
                          ...
                          ci = c(
                            std.error(beldes$dif_bel_base)*qt(.95/2+.5,length(beldes$dif_bel_base)-1),
                            std.error(beldes$dif_des_base)*qt(.95/2+.5,length(beldes$dif_des_base)-1),
                            std.error(beldes$dif_phys_base)*qt(.95/2+.5,length(beldes$dif_phys_base)-1)))
